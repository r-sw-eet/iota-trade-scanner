...
**Ecosystem evolution (per MagicSea's own Medium posts):** TangeSea was the original ShimmerSea community team; they renamed their DEX to MagicSea and their governance/utility token stack now spans \`$LUM\` + \`$MAGIC\` (with Magic-LUM lock-boosted staking). Lumis were never sold during their original distribution — they were airdropped to community members who had been with (what's now) MagicSea for years. The on-chain Rebased deployment here mirrors that original ShimmerEVM mint.
