...
The IOTA Names deployer \`0xfc684adb479789acb754d98b952deb46dbbeeaa9cb6d431b95c8f7d72e893af1\` ships 6 packages, all containing a \`name_registration\` module whose \`NameRegistration\` objects carry \`name_str\` values ending in \`.iota\`. Cross-references to the IF source at \`github.com/iotaledger/iota-names\` and the \`@iota/iota-names-sdk\` npm package under the reserved \`@iota\` scope.
